...
- Операционная система: Windows 10 21H2 или выше.
...
- [ ] Возможность взаимодействия с скрытой панелью задач Windows
- [ ] Работа поверх приложений и игр с эксклюзивным полноэкранным режимом
- [ ] Порт на Linux и MacOS
